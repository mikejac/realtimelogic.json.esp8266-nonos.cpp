 ...
 *			      HEADER
 *
 *   $Id: JVal.h 3459 2014-08-18 22:38:07Z wini $
 *
...
struct JVal
{
       ...
       */
      JVType ICACHE_FLASH_ATTR getType();

      /** Equivalent to get with variable argument list replaced by argList.
       */
      JVal* ICACHE_FLASH_ATTR vget(JErr* err,const char** fmt, va_list* argList);
      ...
      \sa JEncoder::set
       */
      JVal* /*ICACHE_FLASH_ATTR*/ get(JErr* err, const char* fmt, ...);
       ...
       */
      S32 ICACHE_FLASH_ATTR getInt(JErr* e);

      /** Sets a new integer value or changes the JSON type and sets the
          integer value.
      */
      void ICACHE_FLASH_ATTR setInt(JErr* e,S32 v);
      ...
      */
      int ICACHE_FLASH_ATTR addMember(JErr* e, const char* memberName,
      ...
      /** Add a child to an array.
          ...
          \param child is the element to add.
      */
      int ICACHE_FLASH_ATTR add(JErr* e, JVal* child);
       ...
       */
      void ICACHE_FLASH_ATTR terminate(AllocatorIntf* vAlloc, AllocatorIntf* dAlloc);
#endif
      union
      {
...
BA_API JVal* ICACHE_FLASH_ATTR JVal_vget(JVal* o,JErr* err,const char** fmt, va_list* argList);
BA_API JVal* ICACHE_FLASH_ATTR JVal_get(JVal* o, JErr* err, const char* fmt, ...);
BA_API S32 ICACHE_FLASH_ATTR JVal_getInt(JVal* o, JErr* e);
BA_API S64 ICACHE_FLASH_ATTR JVal_getLong(JVal* o, JErr* e);
BA_API double ICACHE_FLASH_ATTR JVal_getDouble(JVal* o, JErr* e);
BA_API BaBool ICACHE_FLASH_ATTR JVal_getBoolean(JVal* o, JErr* e);
BA_API const char* ICACHE_FLASH_ATTR JVal_getString(JVal* o, JErr* e);
BA_API char* ICACHE_FLASH_ATTR JVal_manageString(JVal* o, JErr* e);
BA_API const char* ICACHE_FLASH_ATTR JVal_getName(JVal* o);
BA_API char* ICACHE_FLASH_ATTR JVal_manageName(JVal* o);
#define JVal_getNextElem(o) (o)->next
BA_API JVal* ICACHE_FLASH_ATTR JVal_getObject(JVal* o, JErr* e);
BA_API JVal* ICACHE_FLASH_ATTR JVal_getArray(JVal* o, JErr* e);
BA_API JVal* ICACHE_FLASH_ATTR JVal_getJ(JVal* o, JErr* e);
BA_API JVal* ICACHE_FLASH_ATTR JVal_manageJ(JVal* o, JErr* e);
BA_API S32 ICACHE_FLASH_ATTR JVal_getLength(struct JVal* o, JErr* e);
#define JVal_isObjectMember(o) ((o)->memberName != 0) 
BA_API int ICACHE_FLASH_ATTR JVal_unlink(JVal* o, JVal* child);
BA_API int ICACHE_FLASH_ATTR JVal_addMember(JVal* o, JErr* e, const char* memberName,
                          JVal* child, AllocatorIntf* dAlloc);
BA_API int ICACHE_FLASH_ATTR JVal_add(JVal* o, JErr* e, JVal* child);
BA_API void ICACHE_FLASH_ATTR JVal_terminate(JVal* o, AllocatorIntf* vAlloc,
...
BA_API void ICACHE_FLASH_ATTR JVal_setX(JVal* o, JErr* e, JVType t, void* v);
#ifdef __cplusplus
}
...
typedef struct JParserValFact : public JParserIntf
{
      ...
      */
      ...
      void init(AllocatorIntf* vAlloc, AllocatorIntf* dAlloc);
...
inline void JParserValFact::init(
   AllocatorIntf* vAlloc, AllocatorIntf* dAlloc){
   JParserValFact_constructor(this, vAlloc, dAlloc);}
...
inline void JValFact::init(AllocatorIntf* vAlloc, AllocatorIntf* dAlloc) {
   JValFact_constructor(this,vAlloc, dAlloc); }
